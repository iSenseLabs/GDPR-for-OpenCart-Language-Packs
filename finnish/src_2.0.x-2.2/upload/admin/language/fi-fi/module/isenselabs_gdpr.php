...
// Heading
$_['heading_title']    			= 'GDPR Asetukset';

// Text
$_['text_extension']   			= 'Liitännäiset';
$_['text_success']     			= 'Onnistui: Muokkasit GDPR asetuksia!';
$_['text_edit']        			= 'Muokkaa sovellusta';
$_['text_module']      			= 'Sovellukset';
...
$_['error_unexpected'] 			= 'Odottamaton virhe tapahtui. Yritä myöhemmin uudestaan tai ota yhteyttä sovelluksen kehittäjiin ja ilmoita seuraava virhekoodi: ';

// Licensing
$_['text_your_license']         = 'Sinun lisenssi';
$_['text_please_enter_the_code']= 'Ole hyvä ja anna lisenssikoodisi:';
$_['text_activate_license']     = 'Aktivoi lisenssi';
$_['text_not_having_a_license'] = 'Etkö ole saanut lisenssikoodia? Pyydä sitä täältä.';
$_['text_license_holder']       = 'Lisenssinhaltija';
$_['text_registered_domains']   = 'Rekisteröidyt domainit';
$_['text_expires_on']           = 'Lisenssi vanhenee';
$_['text_valid_license']        = 'LISENSSI VOIMASSA';
$_['text_manage']               = 'hallitse';
...
$_['tab_home']       			= 'Tarkistuslista';
$_['tab_controlpanel'] 			= 'Asetukset';
$_['tab_support']       		= 'Tuki';
$_['tab_requests']				= 'Pyynnöt';
$_['tab_acceptances']			= 'Ehtojen hyväksynnät';
$_['tab_personaldata']			= 'Kolmannet osapuolet';
$_['tab_datasecurity']			= 'Tietojen suojaus';

$_['text_loading_data']		 	= 'Tietoja ladataan, odota hetki...';
$_['text_no_results']			= 'Ei tuloksia nykyisellä haulla.';

$_['column_request_id']			= 'Pyynnön tunnus';
$_['column_type']				= 'Tyyppi';
$_['column_email']				= 'Sähköposti';
$_['column_accept_language']	= 'Kieliasetus';
$_['column_user_agent']			= 'Selain';
$_['column_server_ip']			= 'Palvelimen IP';
$_['column_client_ip']			= 'Asiakkaan IP';
$_['column_date']				= 'Päivä';
$_['column_acceptance_id']		= 'Hyväksyntätunnus';
$_['column_name']				= 'Nimi';
$_['column_content']			= 'Tekstisisältö';
$_['column_actions']			= 'Toimenpiteet';

$_['text_date_start']			= 'Alkupäivämäärä';
$_['text_date_end']				= 'Loppupäivämäärä';
$_['text_filter']				= 'Suodatus';
$_['text_download']				= 'Lataa';
$_['text_view_current']			= 'Näytä tämänhetkiset ehdot';

$_['text_life_of_links']		= 'GDPR hakujen erääntymisaika';
$_['text_access_to_personal_data_link'] = 'Pääsy henkilötietoihin';
$_['text_access_to_personal_data_link_helper'] = 'Henkilötietopyyntöjen erääntymisaika (tunneissa). Mikäli asiakas ei vahvista pyyntöä tämän ajan puitteissa, pyyntö erääntyy ja hänen täytyy tehdä uusi pyyntö.';
$_['text_access_default_hours'] = 'Oletusaika: 5 tuntia';

$_['text_remove_personal_data_link'] = 'Henkilötietojen poistaminen';
$_['text_remove_personal_data_link_helper'] = 'Asiakkaan henkilötietojen poistamispyyntöjen/anonymisoinnin erääntymisaika (tunneissa). Mikäli asiakas ei vahvista pyyntöä tämän ajan puitteissa, pyyntö erääntyy ja hänen täytyy tehdä uusi pyyntö.';
$_['text_delete_default_hours'] = 'Oletusaika: 2 tuntia';

$_['text_access_to_personal_data'] = 'Pääsy henkilötietoihin';
$_['text_access_to_personal_data_helper'] = 'Sinun täytyy ilmoittaa palvelut joiden kanssa jaat asiakkaiden tietoja (kuten nimi, sähköposti, asiakastunnus, IP-osoite yms.) allaoleviin kenttiin.';
$_['text_third_party_services'] = 'Kolmansien osapuolten palvelut';
$_['text_third_party_services_helper'] = 'Ilmoita tässä palvelut joita käytät esimerkiksi kävijöiden seurantaan, analytiikkaan tai kävijäkokemuksen parantamiseen. Esimerkiksi: Facebook mainokset, Facebook Pixel, Google Analytics, Google AdWords, Google Retargeting, MailChimp, jne.';
$_['text_other_services'] = 'Muut palvelut';
...
$_['text_cc_banner_bottom'] = 'Palkki alhaalla';
$_['text_cc_banner_top'] = 'Palkki ylhäällä';
$_['text_cc_banner_top_pushdown'] = 'Palkki ylhäällä (esiintyöntyvä)';
$_['text_cc_banner_float_left'] = 'Vasemmalla leijuva';
$_['text_cc_banner_float_right'] = 'Oikealla leijuva';
$_['text_cc_link_to_pp'] = 'Näytä palkissa linkki tietosuojaselosteeseen';
$_['text_cc_link_to_pp_helper'] = 'Mikäli asetus päällä, linkki tietosuojaselosteeseen näytetään palkissa.';
$_['text_cc_texts'] = 'Mukautettavat tekstit';
$_['text_cc_texts_helper'] = 'Valitse tekstit jotka haluaisit näyttää evästepalkissa.';
$_['text_cc_main_message'] = 'Pääviesti';
$_['text_cc_main_message_helper'] = 'Kirjoita tähän evästepalkissa näkyvä viesti. Muokattava esimerkki on näkyvissä.';
$_['text_cc_pp_message'] = 'Linkki tietosuojaselosteeseen';
$_['text_cc_pp_message_helper'] = 'Kirjoita tähän tietosuojaselosteeseen osoittavan linkin teksti. Muokattava esimerkki on näkyvissä.';
$_['text_cc_accept_text'] = 'Hyväksy-napin teksti';
$_['text_cc_accept_text_helper'] = 'Hyväksyntänapissa näkyvä teksti.';
$_['text_cc_dismiss_text'] = 'Sulje-napin teksti';
$_['text_cc_dismiss_text_helper'] = 'Sulje-napin teksti.';
$_['text_cc_track_pp_clicks'] = 'Seuraa Tietosuojaselosteen hyväksyntöjä';
$_['text_cc_track_pp_clicks_helper'] = 'Mikäli asetus päällä, "Hyväksyn" napin painallukset kirjataan sovelluksen lokitiedostoon sivuston tietosuojaselosteen hyväksyntöinä.';
$_['text_cc_bar_bg'] = 'Palkin taustaväri';
$_['text_cc_bar_text'] = 'Tekstin väri evästepalkissa';
$_['text_cc_button_bg'] = 'Napin taustaväri';
$_['text_cc_button_text'] = 'Napin teksti';
$_['text_cc_palette'] = 'Väripaletti';
$_['text_cc_palette_styling'] = 'Valitse evästepalkin tyyli.';

// Dashboard
$_['text_steps_gdpr_compliant'] = 'GDPR Tarkistuslista';
$_['text_install_the_extension'] = 'Asenna sovellus';
$_['text_install_the_extension_helper'] = 'Varmista että sovellus on asennettu ja kaikki tarpeelliset tiedostot ladattu palvelimelle.';
$_['text_enable_the_extension'] = 'Aktivoi sovellus';
$_['text_enable_the_extension_helper'] = 'Aktivoi sovellus asetusvalikosta.';
$_['text_track_policy_acceptances'] = 'Aloita ehtojen ja käytäntöjen hyväksyntöjen seuranta';
$_['text_track_policy_acceptances_helper'] = 'Euroopan Unionin GDPR asetus edellyttää että sinun tulee tietää tarkalleen koska ja minkä ehdon tai käytännön asiakas on hyväksynyt.';
$_['text_respont_gdpr_requests'] = 'Aloita GDPR pyyntöjen vastaanottaminen ja niihin vastaaminen';
$_['text_respont_gdpr_requests_helper'] = 'Tämä sovellus hoitaa GDPR pyynnöt automaattisesti. GDPR asetuksen mukaisesti sinun tulee vastata kaikkiin GDPR:ään liittyviin pyyntöihin 72 tunnin kuluessa. Tämän sovelluksen ansiosta GDPR pyynnöt hoidetaan automaattisesti ja välittömästi.';
...
$_['text_data_security_breach_helper'] = 'Käytä tätä toimintoa ilmoittaaksesi asiakkaille mikäli kaupassasi tapahtuu tietoturvaloukkaus.';
$_['text_data_security_breach_helper_additional'] = 'Sinun täytyy ilmoittaa asiakkaillesi tarkalleen koska tietoturvaloukkaus tapahtui, kuinka moneen käyttäjätiliin se vaikutti, ja mitkä ovat toimenpiteet jotka on tehty tietoturvaloukkauksen havaitsemisen jälkeen.';

$_['text_gdpr_checklist_helper'] = 'Ole hyvä ja käytä oheista GDPR-tarkistuslistaa merkitäksesi kaikki toimenpiteet jotka olet suorittanut. Klikkaa merkitäksesi.';
$_['text_gdpr_check_1'] = 'GDPR-sovellus on aktivoitu';
$_['text_gdpr_check_1_helper'] = 'Tämä on ensimmäinen helppo askel otettavaksi jotta kauppasi on GDPR määräysten mukainen.';
$_['text_gdpr_check_2'] = 'Lisää GDPR Linkki sivustosi alalaitaan';
$_['text_gdpr_check_2_helper'] = 'Sovelluksessa on tämä toiminto. Voit ottaa sen käyttöön <strong>Asetukset</strong> välilehdeltä.';
...
$_['text_gdpr_check_6_helper'] = 'Sovelluksessa on tämä toiminto. Asiakkaasi voivat pyytäää ja ladata henkilökohtaiset tiedot. Voit testata toimintoa asiakkaan näkökulmasta täältä - [link]';
$_['text_gdpr_check_7'] = 'Anna asiakkaillesi mahdollisuus tulla unohdetuksi';
$_['text_gdpr_check_7_helper'] = 'Sovelluksessa on tämä toiminto. Voit testata toimintoa asiakkaan näkökulmasta täältä - [link]';
$_['text_gdpr_check_8'] = 'Anna asiakkaillesi mahdollisuus muokata omia tietojaan';
$_['text_gdpr_check_8_helper'] = 'Sovelluksessa on tämä toiminto. Voit testata toimintoa asiakkaan näkökulmasta täältä - [link]';
$_['text_gdpr_check_9'] = 'Aloita käyttämään Evästeiden hyväksyntäpalkkia jos sinulla ei ole vielä sellaista. (Valinnainen)';
$_['text_gdpr_check_9_helper'] = 'Sovelluksessa on tämä toiminto. Voit ottaa sen käyttöön  <strong>Evästeden hyväksyntä</strong> välilehdeltä ja muokata asetuksia ja tyyliä kauppaasi soveltuvaksi.';
$_['text_gdpr_check_10'] = 'Tarkastele ja hallinnoi GDPR pyyntöjä ja suostumuksia';
$_['text_gdpr_check_10_helper'] = 'Sovelluksessa on tämä toiminto. Voit käyttää toimintoa <strong>Pyynnöt</strong> and <strong>Ehtojen hyväksynnät</strong> välilehdiltä.';
$_['text_link'] = '[LINKKI]';
